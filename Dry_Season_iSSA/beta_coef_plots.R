...
filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/slope.png")
...
veg_betas_plot <- ggplot(data= veg_betas)+
  geom_point(aes(x = Lion, y = Beta$coef, color = Sex, shape = Significant, fill = Sex), size = 2.5)+
  geom_errorbar(aes(x = Lion, ymin = Low_CI$coef, ymax = High_CI$coef, color = Sex), width = 0.3)+
  labs(title = "DS for Vegetation Cover")+
  geom_hline(yintercept = 0, linetype = 2)+
  xlab("Lion ID")+
...
filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/veg_betas.png")
ggsave(filename = filename,
       device = "png",
       plot = veg_betas_plot,
       width = 6,
...
distEdge_betas_plot <- ggplot(data= distEdge_betas)+
  geom_point(aes(x = Lion, y = Beta$coef, color = Sex, shape = Significant, fill = Sex), size = 2.5)+
  geom_errorbar(aes(x = Lion, ymin = Low_CI$coef, ymax = High_CI$coef, color = Sex), width = 0.3)+
  labs(title = "DS Distance to Home Range Edge")+
  geom_hline(yintercept = 0, linetype = 2)+
  xlab("Lion ID")+
  ylab("Selection for Distance to Home Range Edge")+
  theme_bw() +
  plot_theme +
  scale_shape_manual(values = c(21,22,23,24,4))

filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/distEdge_betas.png")
ggsave(filename = filename,
       device = "png",
...
PreyAbundance_betas_plot <- ggplot(data= PreyAbundance_betas)+
  geom_point(aes(x = Lion, y = Beta$coef, color = Sex, shape = Significant, fill = Sex), size = 2.5)+
  geom_errorbar(aes(x = Lion, ymin = Low_CI$coef, ymax = High_CI$coef, color = Sex), width = 0.3)+
  labs(title = "DS Probability of Encountering Prey")+
  geom_hline(yintercept = 0, linetype = 2)+
  xlab("Lion ID")+
  ylab("Selection for Probability of Encountering Prey")+
  theme_bw()+
  plot_theme +
  scale_shape_manual(values = c(22,23,4))

filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/PreyAbundance_betas.png")
ggsave(filename = filename,
       device = "png",
...
PreyCatchability_betas_plot <- ggplot(data= PreyCatchability_betas)+
  geom_point(aes(x = Lion, y = Beta$coef, color = Sex, shape = Significant, fill = Sex), size = 2.5)+
  geom_errorbar(aes(x = Lion, ymin = Low_CI$coef, ymax = High_CI$coef, color = Sex), width = 0.3)+
  labs(title = "DS Probability of Catching Prey")+
  geom_hline(yintercept = 0, linetype = 2)+
  xlab("Lion ID")+
...
filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/PreyCatchability_betas.png")
ggsave(filename = filename,
       device = "png",
...
filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/PreyAbundanceNight_betas.png")
ggsave(filename = filename,
       device = "png",
...
filename <- paste("~/Documents/Lion_Movement/R/hip_lion_issa/scripts/Dry_Season_iSSA/plots/PreyCatchabilityNight_betas.png")
ggsave(filename = filename,
       device = "png",
